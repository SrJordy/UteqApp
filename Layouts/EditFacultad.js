...
import { View, Text, TextInput, TouchableOpacity, Linking, ScrollView, Alert, Modal } from 'react-native';
import Icon from 'react-native-vector-icons/FontAwesome';
import { stylesEDitF } from './Styles/Styles';
...
const EditFacultadModal = ({ visible, onSave, onCancel, facultadData }) => {
  ...
  return (
    <Modal visible={visible} transparent animationType="fade" onRequestClose={onCancel}>
      <View style={stylesEDitF.modalContainer}>
        <View style={stylesEDitF.modalContent}>
          <ScrollView contentContainerStyle={stylesEDitF.scrollViewContent}>
            <Text style={stylesEDitF.modalTitle}>Editar Facultad</Text>

            <Text style={stylesEDitF.modalLabel}>Nombre de la Facultad</Text>
            <TextInput
              style={stylesEDitF.modalInput}
              placeholder="Nombre de la facultad"
              value={editedNombre}
              onChangeText={setEditedNombre}
            />

            <Text style={stylesEDitF.modalLabel}>Misión</Text>
            <TextInput
              style={stylesEDitF.modalInput}
              placeholder="Misión"
              multiline
            ...
            <Text style={stylesEDitF.modalLabel}>Visión</Text>
            <TextInput
              style={stylesEDitF.modalInput}
              placeholder="Visión"
              multiline
            ...
            <Text style={stylesEDitF.modalLabel}>URL del Video Promocional</Text>
            <TextInput
              style={stylesEDitF.modalInput}
            ...
            <Text style={stylesEDitF.modalLabel}>URL de Facebook</Text>
            <TextInput
              style={stylesEDitF.modalInput}
            ...
            <Text style={stylesEDitF.modalLabel}>URL del Sitio Web</Text>
            <TextInput
              style={stylesEDitF.modalInput}
            ...
            <Text style={stylesEDitF.modalLabel}>Dirección de Gmail</Text>
            <TextInput
              style={stylesEDitF.modalInput}
            ...
            <Text style={stylesEDitF.modalLabel}>Coordenadas (Latitud, Longitud) o Dirección</Text>
            <View style={stylesEDitF.coordinatesContainer}>
            <TextInput
                style={stylesEDitF.coordinateInput}
              ...
              />
              <TouchableOpacity style={stylesEDitF.getCoordinatesButton} onPress={handleGetCoordinates}>
              <Icon name="search" size={20} color="#FFFFFF" />
              </TouchableOpacity>
              <TouchableOpacity style={stylesEDitF.googleMapsButton} onPress={openGoogleMaps}>
                <Icon name="map" size={20} color="#FFFFFF" />
              </TouchableOpacity>
            </View>

            <View style={stylesEDitF.modalButtonContainer}>
              <TouchableOpacity
                style={{ ...stylesEDitF.modalButton, backgroundColor: '#46741e' }}
                onPress={handleSave}
              >
                <Icon name="save" size={20} color="#FFFFFF" style={{ marginRight: 8 }} />
                <Text style={stylesEDitF.modalButtonText}>Guardar</Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={{ ...stylesEDitF.modalButton, backgroundColor: '#d32f2f' }}
                onPress={onCancel}
              >
                <Icon name="close" size={20} color="#FFFFFF" style={{ marginRight: 8 }} />
                <Text style={stylesEDitF.modalButtonText}>Cancelar</Text>
              </TouchableOpacity>
            </View>
          </ScrollView>
        </View>
